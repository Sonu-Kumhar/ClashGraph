...
const judgeNode: GraphNode<typeof State> = async (state: typeof State) =>{
    ...
    const judgeResponse = await judge.invoke({
        messages: [
            new HumanMessage(
            'You are a judge tasked with evaluating the quality of two solutions to a problem. Please provide a score between 0 and 10 for each solution, where 0 indicates a poor solution and 10 indicates an excellent solution.\n\n' +
